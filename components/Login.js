    ...
    <form onSubmit={connect}>
      <div className='bg-gray-100 rounded-md px-12 py-14 flex flex-col space-y-4 w-96'>
        <div className='font-semibold text-2xl text-center'>
          Signin with Sendbird Call SDK.
        </div>
        <p className='text-xs'>You will need to give permission to Camera and Mic.</p>
        ...
        <div>
          ...
          <div className='mt-2'>
            ...
            <p className='text-[#FF0000] text-xs'>{status}</p>
          </div>
        </div>
        <div>
          <div className='mt-2'>
