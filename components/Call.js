...
const Call = () => {
  ...
  const initiateSendbirdCalls = async () => {
    ...
    try {
      ...
      await authenticate();
      setStatus('connecting to websocker server')

      await SendBirdCall.connectWebSocket();
      setStatus('Adding Handler')
      addEventHandler();
        ...
        <>
                ...
                <div>
                  ...
                  {!loading && !authenticated && (
                    <div>
                      ...
                      <Login userId={userId} setUserId={setUserId} status={status}/>
                    </div>
                  )}
                </div>
                {typeof window !== 'undefined' && (
          ...
          {!userId && (
            <div>
              ...
              <Login setUserId={setUserId} status={status} />
            </div>
          )}
        </>
      </div>
